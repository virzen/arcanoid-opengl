...
ColorShader::ColorShader() : Shader("shader/color/vertexShader.vert", nullptr, "shader/color/fragmentShader.frag") {}

void ColorShader::draw(Model* model, glm::mat4 perspectiveMatrix, glm::mat4 viewMatrix) {
