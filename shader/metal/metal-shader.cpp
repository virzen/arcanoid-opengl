...
MetalShader::MetalShader(const char* textureFile) : Shader("shader/metal/vertexShader.vert", nullptr, "shader/metal/fragmentShader.frag") {
...
void MetalShader::draw(Model* model, glm::mat4 perspectiveMatrix, glm::mat4 viewMatrix) {
